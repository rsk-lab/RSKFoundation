//
// ObjectsControllerProtocol.swift
//
...
/// The protocol to be adopted by a type of object that represents a controller of a collection of objects.
public protocol ObjectsControllerProtocol: ObjectControllerProtocol {}
