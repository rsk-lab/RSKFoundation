//
// ObjectDependenciesProtocol.swift
//
...
/// The protocol to be adopted by a type of object that represents dependencies of another object.
public protocol ObjectDependenciesProtocol: ObjectProtocol {}
