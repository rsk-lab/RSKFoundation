//
// ObjectsChanges+ObjectUpdate.swift
//
...
public extension ObjectsChanges {
    ...
    struct ObjectUpdate: Hashable, ObjectProtocol {
        ...
        /// An identifier of the updated object.
        public let objectIdentifier: ObjectIdentifierType
        
        /// An index path of the updated object.
        public let objectIndexPath: IndexPath
        
        // MARK: - Public Initializers
        
        ///
        /// Initializes and returns a new `ObjectUpdate` object with the specified `objectIdentifier` and `objectIndexPath`.
        ///
        /// - Parameters:
        ///     - objectIdentifier: The identifier of the updated object.
        ///     - objectIndexPath: The index path of the updated object.
        ///
