...
//! Project version number for RSKFoundation.
FOUNDATION_EXPORT double RSKFoundationVersionNumber;

//! Project version string for RSKFoundation.
FOUNDATION_EXPORT const unsigned char RSKFoundationVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <RSKFoundation/PublicHeader.h>
