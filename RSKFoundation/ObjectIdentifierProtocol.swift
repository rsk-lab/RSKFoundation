...
/// The protocol to be adopted by a type of object that represents an identifier of another object.
public protocol ObjectIdentifierProtocol: Hashable, ObjectProtocol {}
