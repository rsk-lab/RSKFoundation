//
// ObjectControllerProtocol.swift
//
...
/// The protocol to be adopted by a type of object that represents a controller of another object.
public protocol ObjectControllerProtocol: ObjectProtocol {}
